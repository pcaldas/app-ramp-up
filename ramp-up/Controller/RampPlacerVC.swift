...
//  ramp-up
//
//  Created by Paulo Caldas on 28/04/2018.
...
class RampPlacerVC: UIViewController, ARSCNViewDelegate, UIPopoverPresentationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let gesture1 = UILongPressGestureRecognizer(target: self, action: #selector(RampPlacerVC.onLongPress(gesture:)))
        let gesture2 = UILongPressGestureRecognizer(target: self, action: #selector(RampPlacerVC.onLongPress(gesture:)))
        let gesture3 = UILongPressGestureRecognizer(target: self, action: #selector(RampPlacerVC.onLongPress(gesture:)))
